---
description: Создать новый проект на платформе zerovibe и привязать к нему текущую папку. Используй, когда пользователь пишет "/zerovibe:new", "создай проект zerovibe", "новый проект на zerovibe", "заведи приложение на хостинге", или хочет впервые задеплоить папку, ещё не привязанную к проекту (нет ZEROVIBE_PROJECT в .env).
---
