---
description: Задеплоить zerovibe-приложение на хостинг (платформа собирает образ из твоего кода, контейнер на VM, поддомен, авто-TLS). Используй, когда пользователь просит развернуть, задеплоить, выложить приложение или "запустить в прод".
---
